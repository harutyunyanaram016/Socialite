...
<!-- <div class="main-content">
 -->	<div class="container">
<?php /*	<?php echo e(dd($referrals->render())); ?>*/ ?>
		<div class="row">
			<div class="col-md-4">
						...
						<div class="affiliate-settings">
							...
							<ul class="list-group affliate-followers">
								...
								<li class="list-group-item">
									<?php /*<?php echo e(dd($referral)); ?>*/ ?>
									<div class="connect-link pull-left">
										<a href="<?php echo e(url('/'.$referral->username)); ?>">
											<img src="http://chat.loc/user/avatar/default-male-avatar.png" alt="<?php echo e($referral->name); ?>" title="<?php echo e($referral->name); ?>">
								...
								<div class="pagination">
									<?php /*<?php if($referrals != NULL): ?>*/ ?>
									<?php /*<?php echo e($referrals->render()); ?>*/ ?>
									<?php /*<?php endif; ?>*/ ?>
								</div>
							</ul>
