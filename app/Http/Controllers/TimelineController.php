...
//            var_dump($posts);die;
        ...
        return $theme->scope('home', compact('timeline', 'posts', 'next_page_url', 'trending_tags', 'suggested_users', 'active_announcement'))
       ->render();
    }

    public function purchase(){
        $theme = Theme::uses(Setting::get('current_theme', 'default'))->layout('default');
        return $theme->scope('users/purchase')->render();
    }
    ...
    public function posts($username)
    {
        ...
        return $theme->scope('timeline/posts', compact('timeline', 'user', 'posts', 'liked_pages', 'followRequests', 'joined_groups', 'own_pages', 'own_groups', 'follow_user_status', 'following_count', 'followers_count', 'follow_confirm', 'user_post', 'timeline_post', 'joined_groups_count'))->render();
    }
   ...
   //Getting group members
    ...
    public function getGroupPosts($username, $group_id)
    {
        ...
        return $theme->scope('timeline/groupposts', compact('timeline', 'group', 'posts', 'group_members'))->render();
    }
    ...
    public function getPagePosts($username)
    {
        ...
        return $theme->scope('timeline/pageposts', compact('timeline', 'posts', 'page', 'page_user_id', 'page_members'))->render();
    }
    ...
    public function singlePost($post_id)
    {
        ...
        return $theme->scope('timeline/single-post', compact('post', 'suggested_users', 'trending_tags'))->render();
    }
}
